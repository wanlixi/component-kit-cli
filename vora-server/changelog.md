...
- 新增 process.env.VORA_CLI_VERSION 环境变量
...
- 升级依赖
- 优化代码块与底部文字之间的间距
- 修复 create-vora-cli-app 初始化时报错的问题

### v2.2.4

`2020-02-14`

- 修复在 windows 上构建出的样式入口文件路径错误的问题
...
- 修复在 windows 上获取 markdown 路径错误的问题 
